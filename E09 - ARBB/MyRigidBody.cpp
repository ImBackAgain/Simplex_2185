...
bool MyRigidBody::IsColliding(MyRigidBody* const other)
{
	...
	if (bColliding) //they are colliding with bounding sphere
	{
		if (this->m_v3MaxG.x < other->m_v3MinG.x) //this to the right of other
			bColliding = false;
		else if (this->m_v3MinG.x > other->m_v3MaxG.x) //this to the left of other
			bColliding = false;

		else if (this->m_v3MaxG.y < other->m_v3MinG.y) //this below of other
			bColliding = false;
		else if (this->m_v3MinG.y > other->m_v3MaxG.y) //this above of other
			bColliding = false;

		else if (this->m_v3MaxG.z < other->m_v3MinG.z) //this behind of other
			bColliding = false;
		else if (this->m_v3MinG.z > other->m_v3MaxG.z) //this in front of other
			bColliding = false;
